...
/**
 * Representation of a Chess Piece. Offers functionality to get the square this piece is on and the
 * list of possible moves this piece can go to
 */
public interface IChessPiece {
  ...
  /**
   * Gets a list of the possible moves the piece can make given the chess board the piece is on.
   * Ensures that the given board contains this piece on this piece's square.
   *
   ...
   */
  boolean canMoveTo(IChessBoard chessBoard, IChessSquare destinationSquare)
