...
public interface IChessSquare {
  ...
  /**
   * Determines the Enum {@link EChessSquareStartingPiece} for this square.
   *
   * @return an enum representing what piece (or empty) starts on this square on a reset board
   */
